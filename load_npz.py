...
def load_npz_data(dataset_str, seed, task_type):  # load co-author, Amazon datasets.
...
def load_npz_data_ood_train(dataset_str, seed):  #for ood accuarcy # load co-author, Amazon datasets.
    adj, features, labels = get_dataset("data/{}.npz".format(dataset_str), True)
    features = features.toarray() 
    adj = adj.tocoo()
